...
public class RlvArticleAdapter extends BaseQuickAdapter<ArticleItemBean, BaseViewHolder> {
    public RlvArticleAdapter(int layoutResId, @Nullable List<ArticleItemBean> data) {
