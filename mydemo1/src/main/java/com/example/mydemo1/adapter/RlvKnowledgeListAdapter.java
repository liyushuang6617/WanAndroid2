...
public class RlvKnowledgeListAdapter extends BaseQuickAdapter<KnowledgeItemBean, BaseViewHolder> {
    public RlvKnowledgeListAdapter(int layoutResId, @Nullable List<KnowledgeItemBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, KnowledgeItemBean item) {
