package com.example.wanandroid2.adapter;
...
import com.example.wanandroid2.utils.GlideImageLoader;

import java.util.List;

public class RlvArticelItemAdapter extends BaseQuickAdapter<ArticleItemData, BaseViewHolder> {
    public RlvArticelItemAdapter(int layoutResId, @Nullable List<ArticleItemData> data) {
